...
class DatabaseSeeder extends Seeder {
    ...
    public function run() {
        ...
        DB::table('servizio')->insert([
            ...
            ['nome_servizio' => 'Locale ricreativo'],
        ]);
