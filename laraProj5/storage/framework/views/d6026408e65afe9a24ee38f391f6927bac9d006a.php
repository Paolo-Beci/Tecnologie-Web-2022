...
<div class="service-container">
    <article class="service">
        <div class="img-container">
            <img src="<?php echo e(asset('images/icons_mano.png')); ?>" alt="" height="75" width="75" >
    ...
    <article class="service">
        <div class="img-container">
            <img src="<?php echo e(asset('images/icons_casa.png')); ?>" alt="" height="75" width="75">
    ...
    <article class="service">
        <div class="img-container">
            <img src="<?php echo e(asset('images/icons_messaggi.png')); ?>" alt="" height="75" width="75">
    ...
    <article class="service">
        <div class="img-container">
            <img src="<?php echo e(asset('images/icons_domanda.png')); ?>" alt="" height="75" width="75">
...
<?php /**PATH C:\Users\DELL\Desktop\Università\Terzo anno\Tecnologie web\Tecnologie-Web-2022\laraProj5\resources\views/helpers/servizi.blade.php ENDPATH**/ ?>