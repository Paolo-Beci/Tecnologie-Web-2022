<ul>
    <li><a class="footer-link" href="mailto:flatmate@gmail.com">Contattaci</a></li>
    ...
    <li><a class="footer-link" id="dicono-di-noi"
        {{(Route::current()->getName() == 'homepage') ? 'href=#dicono-di-noi' : 'data-popup-caller'}}>Dicono di noi</a></li>
